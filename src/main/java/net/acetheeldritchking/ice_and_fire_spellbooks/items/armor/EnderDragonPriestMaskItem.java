...
public class EnderDragonPriestMaskItem extends DragonArmorItem implements IPresetSpellContainer {
    ...
    private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(
            ...
            "textures/models/armor/dragon_priest_mask_ender_glowmask.png");
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        ...
        return new EmissiveGenericCustomArmorRenderer<>(new EnderDragonPriestMaskModel(), LAYER, GLOW_RENDER_TYPE);
    }
}

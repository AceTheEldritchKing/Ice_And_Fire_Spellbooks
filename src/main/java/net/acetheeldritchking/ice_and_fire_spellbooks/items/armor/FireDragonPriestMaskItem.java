...
public class FireDragonPriestMaskItem extends DragonArmorItem implements IPresetSpellContainer {
    public FireDragonPriestMaskItem(Type slot, Properties settings) {
        super(ArmorMaterialRegistries.TOORNAHKRIIN_MASK, slot, settings);
    }
    ...
    private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(
            ...
            "textures/models/armor/dragon_priest_mask_fire_glowmask.png");
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        ...
        return new EmissiveGenericCustomArmorRenderer<>(new FireDragonPriestMaskModel(), LAYER, GLOW_RENDER_TYPE);
    }
}

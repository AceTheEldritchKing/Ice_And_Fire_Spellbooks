...
public class IceDragonPriestStaff extends StaffItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public IceDragonPriestStaff() {
        super(ItemPropertiesHelper.equipment().stacksTo(1).rarity(Rarity.EPIC), IFSStaffTier.ICE_DRAGON_PRIEST_STAFF);
    }

...
public class LightningDragonPriestArmorModel extends DefaultedItemGeoModel<LightningDragonPriestArmorItem> {
    ...
    public ResourceLocation getModelResource(LightningDragonPriestArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "geo/lightning_dragon_priest.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(LightningDragonPriestArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "textures/models/armor/lightning_dragon_priest.png");
    }

    @Override
    public ResourceLocation getAnimationResource(LightningDragonPriestArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "animations/lightning_dragon_priest.animation.json");
    }
}

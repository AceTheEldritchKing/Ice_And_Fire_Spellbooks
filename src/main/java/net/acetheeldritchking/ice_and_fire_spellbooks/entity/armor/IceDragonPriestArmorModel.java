...
public class IceDragonPriestArmorModel extends DefaultedItemGeoModel<IceDragonPriestArmorItem> {
    ...
    public ResourceLocation getModelResource(IceDragonPriestArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "geo/ice_dragon_priest.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(IceDragonPriestArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "textures/models/armor/ice_dragon_priest.png");
    }

    @Override
    public ResourceLocation getAnimationResource(IceDragonPriestArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(IceAndFireSpellbooks.MOD_ID, "animations/ice_dragon_priest.animation.json");
    }
}
